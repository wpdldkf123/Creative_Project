...
public class ShortTerm {
    ...
    public static List<weatherData> getWeatherInfo(String nx, String ny) throws IOException {
        ...
        for (int i = 0; i < 3; i++) {
            list.add(new weatherData(dateStr, baseTime, itemNode));
            date++;
...
//        }
        List<weatherData> list = getWeatherInfo("do", "si");
